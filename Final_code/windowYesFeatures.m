...
%%
WindowConnectivityFeaturesYes=[EEGyesBSI  EEGyesCoherenceMean EEGyesCoherenceMax EEGyesCorrelation];


WindowFeaturesYes=[yesRangeFeatures yesAmplitudeFeatures yesSpectralFeatures];

save('WindowFeaturesYes.mat', 'WindowFeaturesYes')
save('WindowConnectivityFeaturesYes.mat', 'WindowConnectivityFeaturesYes')